...
@Controller
@RequestMapping(value = "/exam/offline/schedulingconf")
public class OfflineSchedulingConfController {
	
	//jsp跳转目录
	private static final String PAGE_FOLDER="exam/offline/";
	
	//线下下载基础数据模版页面
	private static final String PAGE = "scheduling_conf_page";
	
	@Autowired
	private OfflineSchedulingConfService offlineSchedulingConfService;
	...
	//记录日志对象
    private static final MyLogger LOGGER = new MyLogger(OfflineSchedulingConfController.class);
		...
		if(onlineSchedulingConfVo != null){
			if(onlineSchedulingConfVo.getCallNumber()>5){
				...
				if(onlineSchedulingConfVo.getRunningState().equals("0")){
			        ...
			        int flag;
			        flag = offlineSchedulingConfService.allSurveyProc(examId, examRange);
			        if(flag == 0){
			        ...
			        flag = offlineSchedulingConfService.allSumSegmentedProc(examId, examRange);
			        if(flag == 0){
			        	onlineSchedulingConfService.updateOnlineSchedulingConfById(examId,"0");
			        ...
			        flag = offlineSchedulingConfService.allEachSegmentedProc(examId, examRange);
			        if(flag == 0){
			        	onlineSchedulingConfService.updateOnlineSchedulingConfById(examId,"0");
			        ...
			        flag = offlineSchedulingConfService.allLevelSpreadProc(examId, examRange);
			        if(flag == 0){
			        	onlineSchedulingConfService.updateOnlineSchedulingConfById(examId,"0");
			        ...
			        flag = offlineSchedulingConfService.allScoreContrastProc(examId, examRange);
			        if(flag == 0){
			        	onlineSchedulingConfService.updateOnlineSchedulingConfById(examId,"0");
			        ...
			        flag = offlineSchedulingConfService.allExamSituationProc(examId, examRange);
			        if(flag == 0){
			        	onlineSchedulingConfService.updateOnlineSchedulingConfById(examId,"0");
			        ...
			        flag = offlineSchedulingConfService.allPointNameProc(examId, examRange);
			        if(flag == 0){
			        	onlineSchedulingConfService.updateOnlineSchedulingConfById(examId,"0");
			        ...
			        flag = offlineSchedulingConfService.allAbilityNameProc(examId, examRange);
			        if(flag == 0){
			        	onlineSchedulingConfService.updateOnlineSchedulingConfById(examId,"0");
			        ...
			        flag = offlineSchedulingConfService.allQuestionTypeProc(examId, examRange);
			        if(flag == 0){
			        	onlineSchedulingConfService.updateOnlineSchedulingConfById(examId,"0");
			        ...
			        flag = offlineSchedulingConfService.allQuestionNoProc(examId, examRange);
			        if(flag == 0){
			        	onlineSchedulingConfService.updateOnlineSchedulingConfById(examId,"0");
			        ...
			        flag = offlineSchedulingConfService.allSubjectScatterProc(examId, examRange);
			        if(flag == 0){
			        	onlineSchedulingConfService.updateOnlineSchedulingConfById(examId,"0");
