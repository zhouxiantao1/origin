		...
		<div class="content">
			<div class="mid fl">
				...
				<div class="exam_detail">
					<div class="test_name">
						<span><n style="color:#f90202">*</n>学生姓名：</span>
					...
					<div class="test_name">
						<span>学籍号：</span>
						<input type="text" id="number" placeholder="请输入学籍号">
						<em id="title_msg" style="display:none"><img src="${basePath!''}/images/warning_msg.png" class="warning_msg"><i class="err_msg">密码不可以为空</i></em>
					</div>
					<div class="test_way clearfix">
						<span class="fl">性别：</span>
						<label><input type="radio" name="sex" checked value='1'><i>男</i></label>
						<label><input type="radio" name="sex" value='2'><i>女</i></label>
					</div>
				...
				<div class="baocun_1">
					<button class="click_me" onClick="save_student()">保存</button>
...
<script type="text/javascript">
	...
	function save_student(){
		...
		$.ajax({  
			type:'post',  
			url:'${basePath!''}/base/student/list/save.htm', 
			data:{'name':name,'loginName':loginName,'passwork':passwork,'idNum':idNum,'areaId':areaId,'schoolId':schoolId,'sex':sex,'classesId':classesId,'number':num}, 
			async:false,
