		...
		<div class="content">
			<div class="mid fl">
				...
				<div class="exam_detail">
					...
					<div class="test_name">
						<span>班级名称：</span>
						<input type="text" id="classesName" placeholder="请输入班级名称">
...
<script type="text/javascript">
	...
	function save_student(){
		...
		$.ajax({  
			type:'post',  
			url:'${basePath!''}/base/classes/list/save.htm', 
			data:{'name':name,'areaId':areaId,'schoolId':schoolId,'gradeId':gradeId}, 
			async:false,
			success:function(data){  
				window.location.href="${basePath!''}/base/classes/list.htm";
			}  
		});
	}
