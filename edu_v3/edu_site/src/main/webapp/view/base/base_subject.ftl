			...
			<div class="middle middle_1200 fl">
				<div class="nav_list clearfix">
					...
					<div class="new_zhibiao fr">
						<a onClick="javascript:window.location.href='${basePath!''}/base/subject/create.htm'"> <img src="${basePath!''}/images/形状-4.png"> <i>新增学科管理</i></a>
					</div>
				</div>	
				<div class="all_content">
					<div class="operation clearfix">
						<p id="staff" onClick="javascript:window.location.href='${basePath!''}/base/grade/list.htm'">年级管理</p>
						<p id="teacher" class="active">学科管理</p>
						...
						<!-- <div class="mingti fr">
							<button onClick="javascript:window.location.href='${basePath!''}/base/subject/create.htm'"> <i>+</i> 新增</button>
						</div> -->
					</div>
					
					<div class="staff_list_contain">
						<div class="list_one clearfix">
							<p class="fl school_towe">学科名称</p>
					...
					<#if pageBean.list?? && pageBean.list?size!=0>
						<#list pageBean.list as baseSubjectVo>
							<div class="staff_list_contain">
								<div class="some_detail clearfix">
									<p class="fl school_towe">${baseSubjectVo.name!''}</p>
									<p class="fl school_towe" >-</p>
