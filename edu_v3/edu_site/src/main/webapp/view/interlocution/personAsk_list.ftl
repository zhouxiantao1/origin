			...
			<div class="middle middle_1200 fl">
				...
				<div class="nav_list">
					<ul class="paper_list clearfix">
						...
						<@security.authorize url="/interlocution/ask/person/list.htm"><li class="active" >我的提问</li></@security.authorize>
								...
								<li class="clearfix">
									...
									<div class="qus_detail fl">
										...
										<div class="detail clearfix">
											<p class="fl"><grade>【<#if interlocutionAskVo.baseGradeVo??>${interlocutionAskVo.baseGradeVo.name!''}</#if><#if interlocutionAskVo.baseSubjectVo??>${interlocutionAskVo.baseSubjectVo.name!''}</#if>】</grade><#if interlocutionAskVo.isConcren==0><span onclick="save_concern('concern_save',${interlocutionAskVo.id!''})">+关注</span><#else><span onclick="save_concern('concern_update',${interlocutionAskVo.id!''})">已关注</span></#if><ans>回答(${interlocutionAskVo.answerNum!''})</ans></p>
...
<script type="text/javascript">
	...
	function search_ask(type,id){
		var data = "";
		var url = "${basePath!''}/interlocution/ask/person/list.htm?";
		var gradeId =${gradeId!''}+"";
