		...
		<div class="content">
			...
			<div class="mid fl">
				...
				<div class="pop" type='4' style="display: none">
					<h3 class="hand_success clearfix">提交成功 <span class="fr" onClick="answerViewHomework(${homeworkId!''})"></span></h3>
					<div class="finish">
						<h3><img src="${basePath!''}/images/right.png"></h3>
						<p class="tip_msg">恭喜您完成本项练习！</p>
...
<script type="text/javascript">
	...
	function answerViewHomework(homeworkId){
		var url ="${basePath!''}/work/wrong/answer/view.htm?";
		var data = "id="+homeworkId+"&questionId=${questionId!''}";
