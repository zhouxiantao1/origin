...
import com.sjq.common.es.annotation.ESDocObject;
import com.sjq.common.es.annotation.ESField;
import com.sjq.common.es.annotation.EnableSuggest;
...
////        Field[] subfields = esMapTypeClass.getDeclaredFields();
...
//            builder.startObject(suggestName).field("type", "completion").field("index_analyzer", analyzer).field("search_analyzer", analyzer)
//                    .field("payloads", "true").field("preserve_position_increments",false).field("preserve_separators",false).endObject();
//        }
//        builder.endObject();
//    }
//
