...
import com.sjq.common.es.query.QueryItem;

/**
 * 
 * 索引查询请求包装,非线程安全的哦!!!
 * @author SJQ-ZeJie Zheng
 * @since 2017年4月1日下午4:42:10
 * @version 1.0
 */
public class IndexSearchRequest {
     ...
     * @param queryItems
     */
    public void addQueryItems(List<QueryItem> queryItems){
        if (CollectionUtils.isEmpty(queryItems))
            return;
        if (queryItemUnits == null) {
            queryItemUnits = new ArrayList<IQueryItemUnit>();
        }
        queryItemUnits.addAll(queryItems);
    }
    ...
    public void addNestedTermField(String nestedObj, List<IQueryItemUnit> queryItemUnitList) {
        ...
        Map<String, List<IQueryItemUnit>> queryItemMap = new HashMap<String, List<IQueryItemUnit>>();
    ...
    public void addSingleNestedTermField(String nestObj, String fieldName, String fieldValue, ESBoolQueryType queryType, ESQueryWay queryWay) {
        ...
        Map<String, List<IQueryItemUnit>> queryItemUnitMap = new HashMap<String, List<IQueryItemUnit>>();
