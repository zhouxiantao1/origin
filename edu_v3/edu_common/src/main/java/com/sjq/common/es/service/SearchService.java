package com.sjq.common.es.service;
...
import com.sjq.common.es.client.ESClientManager;
import com.sjq.common.es.query.AggregationDefineBean;
import com.sjq.common.es.query.IQueryItemUnit;
import com.sjq.common.es.request.IndexSearchRequest;
import com.sjq.common.es.response.IndexSearchResponse;

/**
 *  
 * 查询service
 * @author SJQ-ZeJie Zheng
 * @since 2017年4月1日下午5:09:19
 * @version 1.0
 */
@Service
...
//     * 搜索
//     *
//     * @param searchRequest {@link IndexSearchRequest}
//     */
...
//
//        // 聚合
//        List<AggregationBuilder> aggregationBuilderList = new ArrayList<AggregationBuilder>();
//        // step3: 普通聚合
...
//        }
//
//        SearchRequestBuilder searchRequestBuilder = transportClient.prepareSearch(searchRequest.getIndexes()).setTypes(searchRequest.getTypes()).setQuery(boolQueryBuilder)
//                .setFrom(searchRequest.getFrom()).setSize(searchRequest.getPageSize());
//
...
//     * @param queryItemUnits   {@link IQueryItemUnit}
//     */
//    private void buildBoolQuery(BoolQueryBuilder boolQueryBuilder, List<IQueryItemUnit> queryItemUnits) {
...
//     * @param index        索引库名称
//     * @param prefix       拼写前缀
//     * @param suggestField suggest field名称
//     * @return 拼写建议的列表
//     */
//    public List<String> getCompletionSuggest(String indices, String prefix, String suggestField) {
...
//        SuggestResponse resp = null;
//        try {
//            resp = client.prepareSuggest(indices)
//                    .addSuggestion(suggestionsBuilder).execute().actionGet();
//        } catch (ElasticsearchException e) {
////            e.printStackTrace();
//            return new ArrayList<String>();
//        }
////        List<? extends Suggest.Suggestion.Entry<? extends TermSuggestion.Entry.Option>>
//        if (resp.getSuggest() != null && resp.getSuggest().getSuggestion("complete") != null) {
//            List<? extends Suggest.Suggestion.Entry<Suggest.Suggestion.Entry.Option>> list = (List<? extends Suggest.Suggestion.Entry<Suggest.Suggestion.Entry.Option>>) resp.getSuggest().getSuggestion("complete").getEntries();
