...
import com.sjq.common.es.request.IndexCreateRequest;

/**
 * 
 * 索引服务
 * @author SJQ-ZeJie Zheng
 * @since 2017年4月1日下午5:08:02
 * @version 1.0
 */
//@Service
...
//        clientManager.getClient().prepareDeleteByQuery(index).setTypes(type).setQuery(queryBuilder).execute().actionGet();
//    }
}
