package com.sjq.common.es.lucene.ikanalyzer.org.wltea.analyzer.dic;
...
import com.sjq.common.es.lucene.ikanalyzer.org.wltea.analyzer.cfg.Configuration;

/**
 * 
 * 词典管理类,单子模式
 * @author SJQ-ZeJie Zheng
 * @since 2017年4月1日下午4:55:15
 * @version 1.0
 */
public class Dictionary {
    ...
    private void loadMainDict() {
        ...
        // 读取主词典文件
        // 读取配置文件里配置的主词典
//        Properties ps = PropertieUtil.readPropertiesFile(this.getClass().getClassLoader().getResourceAsStream("com/sjq/web/config/dictionary.properties"));
        InputStream is = null;
        try {
//            is = new FileInputStream(ps.getProperty("PATH_DIC_MAIN"));
            is = new FileInputStream(Dictionary.class.getClassLoader().getResource("/").getPath()+File.separator+"main2012.dic");
...
//            is = new FileInputStream(ps.getProperty("PATH_DIC_QUANTIFIER"));
            is=new FileInputStream(Dictionary.class.getClassLoader().getResource("/").getPath()+File.separator+"quantifier.dic");
        } catch (FileNotFoundException e1) {
            LOGGER.error(e1.getLocalizedMessage(), e1);
        }
        // 读取类路径下jar包中的量词词典
