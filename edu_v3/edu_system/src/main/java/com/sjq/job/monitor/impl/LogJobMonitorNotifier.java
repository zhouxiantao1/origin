 ...
 * @since 2017年4月6日下午3:55:33
 * @version 1.0
 */
public class LogJobMonitorNotifier implements JobMonitorNotifier {

	// private static final Logger log = Logger.getLogger(LogJobMonitorNotifier.class);
	private static final Logger log = LoggerFactory.getLogger(LogJobMonitorNotifier.class);
