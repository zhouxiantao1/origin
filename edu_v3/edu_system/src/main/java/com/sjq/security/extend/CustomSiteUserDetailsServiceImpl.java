 ...
 * @version 1.0
 */
@Service("customSiteUserDetailsService")
public class CustomSiteUserDetailsServiceImpl implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String userName) throws UsernameNotFoundException, DataAccessException {
		...
		if (user == null) {
			...
			// 查询菜单
			menumap = securityResourceService.querySiteLeftMenu(user.getRoleId());
