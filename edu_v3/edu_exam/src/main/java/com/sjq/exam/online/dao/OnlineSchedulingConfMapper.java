package com.sjq.exam.online.dao;
...
/**
 * 
 * @ClassName:OnlineSchedulingConfMapper
 * @Description:线下考试调度dao
 * @author SJQ-XiaoCong Yin
 * @date 2017年4月27日 上午10:22:41
 * @version 1.0
 */
public interface OnlineSchedulingConfMapper {
	 ...
	 * @return
	 */
	int updateOnlineSchedulingConfById(Map<String, Object> map);
