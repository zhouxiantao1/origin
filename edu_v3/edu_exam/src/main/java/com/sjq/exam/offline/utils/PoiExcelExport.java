...
public class PoiExcelExport {
	...
	public PoiExcelExport(String fileDir,String fileName,String sheetName){
	...
	public String wirteExcel(String titleColumn[],String titleName[],int titleSize[],List<?> dataList){
    	...
    	try {	 
    		...
    		for(int i = 0;i < titleName.length;i++){
	    		...
	    		sheet.autoSizeColumn((short)i);//自动适应列宽
    ...
    public CellStyle setFontAndBorder(CellStyle style,String fontName,short size){
        ...
        font.setFontHeightInPoints(size);//标题字体大小    
