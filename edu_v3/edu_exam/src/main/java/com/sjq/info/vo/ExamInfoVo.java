...
public class ExamInfoVo{
	...
	private List<ExamDetailVo> examDetailVoList;//对应考试的考试科目明细
	...
	public List<ExamDetailVo> getExamDetailVoList() {
		return examDetailVoList;
	}
	public void setExamDetailVoList(List<ExamDetailVo> examDetailVoList) {
