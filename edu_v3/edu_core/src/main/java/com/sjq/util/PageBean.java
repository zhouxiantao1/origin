...
public class PageBean {
    ...
    /**
     * 获取显示的开始页码数与 @see {@link com.sjq.util.PageBean#getEnd()} 相对存在
     * 
    ...
    /**
     * 获取显示的结束页码数 {@link com.sjq.util.PageBean#getStart()}
     * 
     * @return 结束的页码数
     */
    public int getEnd() {
