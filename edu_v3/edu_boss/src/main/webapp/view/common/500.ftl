...
<section id="wrapper" class="error-page">
  <div class="error-box">
    <div class="error-body text-center">
      <h1>500</h1>
      <h3 class="text-uppercase">service error.</h3>
      <p class="text-muted m-t-30 m-b-30">服务器遇到了一个未曾预料的状况，导致了它无法完成对请求的处理！</p>
      <a href="${basePath}/home.htm" tppabs="" class="btn btn-info btn-rounded waves-effect waves-light m-b-40">回到首页</a> </div>
...
<script src="${basePath}/bootstrap/dist/js/bootstrap.min.js" tppabs="http://eliteadmin.themedesigner.in/demos/eliteadmin-crm/bootstrap/dist/js/bootstrap.min.js"></script>
