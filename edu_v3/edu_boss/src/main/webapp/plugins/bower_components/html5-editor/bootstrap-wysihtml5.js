!function($, wysi) {
    ...
    Wysihtml5.prototype = {
        ...
        initHtml: function(toolbar) {
            ...
            toolbar.find(changeViewSelector).click(function(e) {
                toolbar.find('http://eliteadmin.themedesigner.in/demos/plugins/bower_components/html5-editor/a.btn').not(changeViewSelector).toggleClass('disabled');
            });
        },
    ...
    var defaultOptions = $.fn.wysihtml5.defaultOptions = {
        ...
        stylesheets: ["lib/css/wysiwyg-color.css"/*tpa=http://eliteadmin.themedesigner.in/demos/plugins/bower_components/html5-editor/lib/css/wysiwyg-color.css*/], // (path_to_project/lib/css/wysiwyg-color.css)
        locale: "en"
    };
